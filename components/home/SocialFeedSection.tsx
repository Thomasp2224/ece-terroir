...
import { Heart, MessageCircle, ExternalLink, Sparkles, Filter } from 'lucide-react';
    ...
    <section className="py-24 bg-[#141716] text-[#FDFBF7] relative overflow-hidden border-y border-[#D4AF37]/30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          >
            Tous les flux ({socialPosts.length})
          </button>
          <button
            ...
            <ScrollReveal key={post.id} direction="up" delay={idx * 0.1} className="flex">
              ...
              >
                ...
                <div className="p-5 space-y-4 flex-1 flex flex-col justify-between">
                  <p className="text-xs text-[#FDFBF7] leading-relaxed line-clamp-3">
                    {post.content}
                  </p>
